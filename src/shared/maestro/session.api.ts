...
// uses on its own domain) and exposed over electron-xpc as MaestroSessionDao, reached via
// createXpc{Main,Renderer}Emitter<SessionApi>('MaestroSessionDao').
...
// Implemented by MaestroSessionDao (sqlite preload); consumed by main + control via xpc emitters.

...
import { DEFAULT_COACH_START_URL, type CoachXpcContract, type TabInfo } from '@cowork-shared/coach.api'
import type { TabsApi, SavedTab } from '@cowork-shared/tabs.api'

import type { HostToolCatalogEntry, HostToolCatalogResult, HostToolPolicyMap, HostToolScope } from '@cowork-shared/coach.api'
...
export const HOST_TOOL_CATALOG: HostToolCatalogEntry[] = [
  ...
  },
  {
    ...
    useWhen: 'Use when the user asks to add a floating website button/launcher/shortcut for Cowork skills.',
  ...
  },
  {
    ...
    safety: 'Requires apply=true, caps writes per run, uses the Cowork CLI session, updates mappings, never runs from the scheduler, and does not persist source payloads. Linked MCU-record detail updates require allow_updates=true.'
  },
  {

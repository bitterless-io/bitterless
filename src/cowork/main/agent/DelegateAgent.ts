...
/**
 * Delegate — acts AS the user toward the user's CUSTOMER. Same browser/skill tools as Cowork
 ...
 * prompt/delegateSysPrompt.ts. Separate session, so its conversation never mixes with Cowork/Coach.
 */

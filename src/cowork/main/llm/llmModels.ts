import type { LlmEffort, LlmEffortOption, LlmLoginMethod, LlmLoginProviderOption, LlmTarget } from '@cowork-shared/coach.api'
...
// subscription OAuth in coworkAuthPath().
...
export const LLM_PROVIDERS: LlmProviderDefinition[] = [
  ...
  // Claude provider option is intentionally hidden in Cowork for now. Keep the runtime,

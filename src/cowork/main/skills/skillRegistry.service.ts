...
import type { DeleteSkillResult, SkillDetail, SkillExportResult, SkillImportResult, SkillInput, SkillSource, SkillSummary } from '@cowork-shared/coach.api'
  ...
  private ensureAgentGuidance(): void {
    ...
    writeFileSync(
      ...
      [
        ...
        '',
        'This directory is Electron userData for Micromeet Cowork.',
        '',

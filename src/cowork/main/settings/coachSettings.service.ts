...
import { DEFAULT_COACH_START_URL, type CoachSettings } from '@cowork-shared/coach.api'
...
function normalizeLlmProvider(provider: string): string {
  ...
  // Claude is still supported in the runtime, but the Cowork selector is hidden for now.

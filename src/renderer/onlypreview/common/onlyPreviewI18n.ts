...
const en = {
  ...
  project: {
    ...
    pasteConflictTitle: 'Could not paste',
    pasteConflictClose: 'Close',
    ...
    storageStatus: '{free} free · {index} index',
...
const zh: Localized<typeof en> = {
  ...
  project: {
    ...
    pasteConflictTitle: '无法粘贴',
    pasteConflictClose: '关闭',
    treeLabel: '项目文件',
    emptyTitle: '选择工作区',
    ...
    storageStatus: '{free} 可用 · 索引占用 {index}',
    symlink: '符号链接',
    editNameLabel: '重命名',

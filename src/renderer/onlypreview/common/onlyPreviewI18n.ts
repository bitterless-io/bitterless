...
const en = {
  ...
  project: {
    ...
    emptyTitle: 'Open something to inspect',
    emptyBody: 'Choose a file for a focused preview, or a folder to browse its project index.',
  ...
  errors: {
    ...
    PATH_NOT_FOUND: 'The file is no longer at this location. Refresh the project index.',
...
const zh: Localized<typeof en> = {
  ...
  project: {
    ...
    clearSearch: '清除搜索',
    treeLabel: '项目文件',
    emptyTitle: '打开需要查看的内容',
    emptyBody: '选择一个文件直接预览，或选择文件夹浏览项目索引。',
  ...
  errors: {
    ...
    PATH_NOT_FOUND: '文件已不在原位置。请刷新项目索引。',

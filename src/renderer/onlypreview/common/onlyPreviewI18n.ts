...
const en = {
  ...
  project: {
    ...
    emptyTitle: 'Choose a workspace',
    emptyBody: 'Choose a folder as your workspace to browse, search, and preview its files.',
  ...
  globalSearch: {
    ...
    scope: 'Search scope',
    scopeLabel: 'Search scope for files and contents',
...
const zh: Localized<typeof en> = {
  ...
  project: {
    ...
    treeLabel: '项目文件',
    emptyTitle: '选择工作区',
    emptyBody: '选择一个文件夹作为工作区，即可浏览、搜索和预览其中的文件。',

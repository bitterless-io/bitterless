  ...
  <div name="onlypreview__settingsApp" class="onlypreview-settings">
    ...
    <a-spin class="onlypreview-settings__spin" :loading="onlyPreviewSettingsStore.loading">
      <main name="onlypreview__settingsContent" class="onlypreview-settings__content">
        ...
        <section name="onlypreview__settingsPreview" class="onlypreview-settings__section">
        ...
        <section name="onlypreview__settingsProject" class="onlypreview-settings__section">
          <div class="onlypreview-settings__section-heading">
          ...
          <div class="onlypreview-settings__row">
            <div class="onlypreview-settings__copy">
              <label for="onlypreview-hidden-files">{{
                onlyPreviewI18n.settings.hiddenFiles
              }}</label>
              <p>{{ onlyPreviewI18n.settings.hiddenFilesHint }}</p>
            </div>
            <a-switch
              id="onlypreview-hidden-files"
              name="onlypreview__hiddenFiles"
              size="small"
              :model-value="onlyPreviewSettingsStore.draft.showHiddenFiles"
              @change="(value) => onlyPreviewSettingsStore.setShowHiddenFiles(value)"
            />
          </div>
          <div class="onlypreview-settings__row">
            <div class="onlypreview-settings__copy">
        ...
        <section name="onlypreview__settingsAppearance" class="onlypreview-settings__section">
          <div class="onlypreview-settings__section-heading">
          ...
          <div class="onlypreview-settings__row">
            <div class="onlypreview-settings__copy">
              <span class="onlypreview-settings__label">{{ onlyPreviewI18n.settings.theme }}</span>

 ...
 * The compact label names its state — Downloading while the build is fetched, Update once it is
 * ready — and the button is disabled while downloading, becoming enabled when

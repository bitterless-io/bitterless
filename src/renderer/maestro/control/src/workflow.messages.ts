...
export interface WorkflowUiMessages {
 ...
 categories: Record<'active' | 'completed' | 'failed' | 'stopped', string>; partialFailure: string;
...
export const workflowEn: WorkflowUiMessages = {
 categories: { active: 'In progress', completed: 'Completed', failed: 'Failed', stopped: 'Stopped' }, partialFailure: 'Finished with failed Agents',
 ...
 count: '{count} tasks', current:'Current chat',stopAll:'Stop all',stoppingAll:'Stopping…',stop:'Stop Agent',collapse:'Collapse task list',expand:'Expand task list',empty:'No Agent tasks in this chat',emptyHint:'Tasks appear here when a workflow starts.',ended:'Finished',logs:'Work log',result:'Result',scroll:'Scroll to see more',loadError:'Could not load workflow tasks.',stopError:'Could not stop the selected work.',retry:'Retry',rerun:'Rerun entire workflow',retryError:'Could not restart the workflow.',retryUnavailable:'Start this older workflow again with /workflow.',loading:'Loading tasks…',waiting:'{count} waiting for confirmation',failures:'{count} failed',complete:'All tasks finished',working:'Agents are working',states:{queued:'Queued',running:'Running',waiting:'Waiting for tool',approval:'Waiting for you',retrying:'Retrying',stopping:'Stopping',completed:'Completed',failed:'Failed',stopped:'Stopped'}
}
export const workflowZh: WorkflowUiMessages = {
 categories: { active: '进行中', completed: '已完成', failed: '失败', stopped: '已停止' }, partialFailure: '已结束，含失败 Agent',
...
export const workflowZhTw: WorkflowUiMessages = {
 categories: { active: '進行中', completed: '已完成', failed: '失敗', stopped: '已停止' }, partialFailure: '已結束，含失敗 Agent',
 ...
 count:'{count} 個 task',current:'目前會話',stopAll:'全部停止',stoppingAll:'停止中…',stop:'停止 Agent',collapse:'收起 task 清單',expand:'展開 task 清單',empty:'目前會話還沒有 Agent task',emptyHint:'執行 workflow 後，任務會顯示在這裡。',ended:'已結束',logs:'工作紀錄',result:'結果',scroll:'捲動查看更多',loadError:'無法載入 workflow 任務。',stopError:'未能停止所選任務。',retry:'重試',rerun:'重新執行整個 workflow',retryError:'未能重新執行 workflow。',retryUnavailable:'此舊紀錄請用 /workflow 重新啟動。',loading:'正在載入任務…',waiting:'{count} 個等待你確認',failures:'{count} 個失敗',complete:'任務已結束',working:'Agent 正在工作',states:{queued:'排隊中',running:'執行中',waiting:'等待工具',approval:'等待你確認',retrying:'重試中',stopping:'停止中',completed:'已完成',failed:'失敗',stopped:'已停止'}
}
export const workflowId: WorkflowUiMessages = {
 categories: { active: 'Sedang berjalan', completed: 'Selesai', failed: 'Gagal', stopped: 'Dihentikan' }, partialFailure: 'Selesai dengan Agent gagal',

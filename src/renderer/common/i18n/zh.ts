...
export const zh: typeof en = {
  ...
  workflowLibrary: {
    scope: "范围",
    scopes: {"all":"全部","shared":"共享","institution":"机构"},
    importShared: "导入到共享",
  "title": "工作流",
  "institution": "机构",
  "noInstitution": "尚未选择机构",
  "refresh": "刷新工作流",
  "loading": "正在加载工作流…",
  "search": "搜索工作流",
  "retry": "重试",
  "signIn": "登录 Bitterless 账号后查看共享工作流。",
  "noMembership": "暂无有效的机构成员关系，请联系管理员添加。",
  "empty": "你的机构尚未共享工作流。",
  "noMatches": "没有匹配的工作流。",
  "autoSync": "每分钟检查更新",
  "cloud": "可下载",
  ...
  "flow": "流程图",
  "details": "详情",
  "downloading": "正在校验并准备工作流…",
  "keptPrevious": "已保留此前可用的安装。",
  "selectedStep": "选中步骤",
  "selectStep": "选择一个步骤",
  "noStepDescription": "选择步骤，查看它在工作流中的作用。",
  "package": "工作流压缩包",
  "engine": "引擎",
  "cloudRevision": "云端修订",
  "localRevision": "本地修订",
  ...
  "entry": "入口文件",
  "source": "原文",
  "sourceEmpty": "这个工作流没有可显示的原文。",
  "sourceTruncated": "仅显示前 256 KB —— 复制的也只是这一部分。",
  "sourceFailed": "读取原文失败。",
  "sourceNotInstalled": "先下载这个工作流，才能查看原文。",
  "copySource": "复制原文",
  "sourceCopied": "已复制原文",
  "copyCommand": "复制运行命令",
  "authoredPreview": "流程图由压缩包作者提供。查看或同步不会执行工作流；需要运行时，将命令粘贴到聊天中。",
  "previewUnavailable": "暂时无法预览，请重试下载并校验工作流压缩包。",
  "chooseWorkflow": "探索机构共享的工作流",
  "chooseDescription": "选择工作流，下载压缩包、查看步骤，并持续同步本地副本。",
  "emptyGraph": "此压缩包没有提供流程图步骤。",
  "fit": "适应",
  "zoomIn": "放大",
  "zoomOut": "缩小",
  "kinds": {

...
export const zh: typeof en = {
  ...
  app: {
    ...
    onlyPreviewFileMenu: {
      ...
      renameMissingMessage: '该项目已经不在了，重命名没有生效。',
  ...
  browserHistory: {
    searchGoogle: '在 Google 搜索“{query}”',
    title: '浏览历史',
    show: '显示最近浏览历史',
    hide: '隐藏历史候选',
    remove: '从历史记录中移除',
  ...
  workflowLibrary: {
    ...
    retry: '重试',
    empty: '还没有工作流包。',
    emptyHint: '把一个包目录(含 workflow.mjs,里面 export const meta)放进这个目录。',
    noMatches: '没有匹配的工作流。',
    openFolder: '打开工作流目录',
    copyPath: '复制路径',
    pathCopied: '路径已复制',
    ...
    flow: '流程',
    phases: '阶段',
    noPhases: '这个工作流没有声明阶段。',
    phasesNote: '阶段是脚本声明的;每个阶段开几个 agent 由运行时决定,所以没有固定的流程图。',
    details: '详情',
    source: '源码',
    selectedStep: '当前步骤',
    selectStep: '选择一个步骤',
    noStepDescription: '选择一个步骤,查看它在这个工作流里的作用。',
    package: '工作流包',
    engine: '引擎',
    entry: '入口文件',
    size: '入口大小',
    modified: '修改时间',
    steps: '步骤数',
    sourceEmpty: '这个工作流没有可显示的源码。',
    sourceTruncated: '仅显示前 256 KB —— 复制也只复制这一部分。',
    sourceFailed: '源码读取失败。',
    copySource: '复制源码',
    sourceCopied: '源码已复制',
    copyCommand: '复制运行命令',
    authoredPreview: '这张图是作者写的元数据。打开它不会执行工作流;要运行时把命令粘进聊天。',
    previewUnavailable: '这个包读不出来。在目录里修好之后重试。',
    chooseWorkflow: '你的本地工作流',
    chooseDescription: '选择一个包来查看流程、详情与源码。包放在一个你可以打开并直接编辑的目录里。',
    emptyGraph: '这个包没有图上的步骤。',
    fit: '适应',
    zoomIn: '放大',
    zoomOut: '缩小',
    kinds: {
  ...
  maestroControl: {
    chat: {
      ...
      sessionTitleRestored: '已恢复标题“{title}”',
      undoFailed: '无法撤销此次编辑',
      ...
      openSessionExplorer: '在文件资源管理器中打开',
      sessionDirectoryOpened: '会话文件夹已打开',
      sessionLogMissing: '此会话没有留存的模型 I/O 日志，可能创建于日志启用前，或日志已被清理。请发送一条新消息后重试。',
      ...
      browserTabs: {
        ...
        failed: '无法显示标签页',
        selected: '当前操作目标',
        status: { ready: '就绪', cold: '休眠', loading: '加载中', crashed: '已崩溃', destroyed: '已销毁', closed: '已关闭', 'load-failed': '加载失败', unavailable: '不可用' }
      },
      sessionRunning: '进行中',
      sessionUnread: '未读回复',
      archiveSession: "归档会话",
      archiveRunning: "请等待当前回合结束后再归档",
      sessionArchived: "已归档“{title}”",
      sessionRestored: "已恢复“{title}”",
      undoArchive: "撤销",
      archiveFailed: "无法归档会话，请重试。",
      restoreFailed: "无法恢复会话，请重试。",
      renameSession: "双击修改会话标题",
      renameFailed: "无法保存标题，请重试。",
      searchSessions: "搜索会话",
      searchSessionPlaceholder: "搜索标题…",
      searchSessionEmpty: "没有匹配的会话",
      searchSessionStart: "输入会话标题开始搜索",
      openSessionFailed: "无法打开会话，请重试。",
      closeHistory: '关闭会话',
      newChat: '新建会话',
      ...
      newChatUnavailable: '会话已切换或已归档，请从当前会话新建。',
      ...
      busyContent: '已有 4 个会话同时运行。请等待一个完成，或打开运行中的会话继续对话。',
      gotIt: '知道了',
      ...
      steeringFailed: '⚠ 这条消息**未能**加入当前轮次（{detail}）。如仍需处理，请重新发送。',
      emptyTurnModelSilent: '这一轮模型什么都没返回。再发一次，或在上方换一个模型。',
      emptyTurnNoResult: '这一轮我没拿到可用的结果。再发一次，换个说法也许更好。',
      stopped: '已停止。',
      done: '已完成。',
      failed: '失败。',
  ...
  zellij: {
    refreshConfirmTitle: '刷新终端?',
    refreshConfirmMessage: '页面会重新加载。正在跑的 Zellij 会话不会中断,重新连接后照常继续。',
    refreshConfirmOk: '刷新',

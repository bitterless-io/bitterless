...
export const en = {
  ...
  app: {
    ...
    onlyPreviewFileMenu: {
      ...
      renameMissingMessage: 'This item is no longer there. The rename did not take effect.',
  ...
  workflowLibrary: {
    title: 'Workflows',
    refresh: 'Rescan the workflows folder',
    loading: 'Reading the workflows folder…',
    search: 'Search workflows',
    retry: 'Retry',
    empty: 'No workflow packages yet.',
    emptyHint: 'Put a package folder — a workflow.mjs exporting `const meta` — into this folder.',
    noMatches: 'No workflows match your search.',
    openFolder: 'Open workflows folder',
    copyPath: 'Copy path',
    ...
    folder: 'Folder',
    folderPath: 'Package folder',
    dropped: 'Only the first 200 packages are listed.',
    broken: 'This package could not be read',
    flow: 'Flow',
    phases: 'Phases',
    noPhases: 'This workflow declares no phases.',
    phasesNote: 'Phases are what the script declares. How many agents each one opens is decided while it runs, so there is no fixed diagram.',
    details: 'Details',
    source: 'Source',
    selectedStep: 'Selected step',
    selectStep: 'Select a step',
    noStepDescription: 'Select a step to explore its role in this workflow.',
    ...
    modified: 'Modified',
    steps: 'Steps',
    sourceEmpty: 'This workflow has no readable source to show.',
    sourceTruncated: 'Only the first 256 KB is shown — copying copies just this part.',
    sourceFailed: 'The source could not be read.',
    copySource: 'Copy source',
    sourceCopied: 'Source copied',
    copyCommand: 'Copy run command',
    authoredPreview: 'This diagram is authored metadata. Opening it never executes the workflow. Paste the command into chat when you choose to run it.',
    previewUnavailable: 'This package could not be read. Fix it in the folder, then retry.',
    chooseWorkflow: 'Your local workflows',
    chooseDescription: 'Select a package to inspect its flow, details and source. Packages live in a folder you can open and edit.',
    emptyGraph: 'This package does not include any diagram steps.',
    fit: 'Fit',
    zoomIn: 'Zoom in',
    zoomOut: 'Zoom out',
    kinds: {
  ...
  maestroControl: {
    chat: {
      ...
      copyPath: 'Copy path',
      pathCopied: 'Path copied',
      pathCopyFailed: 'Could not copy the path',
      ...
      emptyTurnModelSilent: 'The model returned nothing this turn. Send it again, or pick a different model above.',
      emptyTurnNoResult: 'I did not get a usable result this turn. Send it again, in different words if that helps.',
      stopped: 'Stopped.',
      done: 'Done.',
      failed: 'Failed.',
  ...
  zellij: {
    refreshConfirmTitle: 'Reload the terminal?',
    refreshConfirmMessage: 'The page reloads. The running Zellij session is not interrupted — it reconnects and carries on.',
    refreshConfirmOk: 'Reload',

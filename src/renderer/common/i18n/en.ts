export const en = {
  ...
  eyesOnAgents: {
    ...
    connection: {
      ...
      managedDescription: 'Bitterless owns this local Codex App Server process and keeps it connected.',
      desktopNote: "This does not attach to Codex Desktop's private App Server. Install the optional Desktop Bridge for lifecycle signals from Desktop tasks.",
      lastSync: 'Last sync',
    ...
    bridge: {
      ...
      description: 'Optional, metadata-only lifecycle coverage for Codex Desktop and CLI tasks.',

export const en = {
  ...
  coin: {
    ...
    codex: {
      ...
      unavailableTitle: 'Codex is not connected',
      unavailableBody: 'Authentication, sessions, and streaming are unavailable in this version.',
      context: 'Context',
      noContext: 'No analysis context',
      composerPlaceholder: 'Codex runtime unavailable',
      send: 'Send',
      newChat: 'New chat unavailable',
    },
    errors: {

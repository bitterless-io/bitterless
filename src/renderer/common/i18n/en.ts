...
export const en = {
  ...
  workflowLibrary: {
    scope: "Scope",
    scopes: {"all":"All","shared":"Shared","institution":"Institution"},
    importShared: "Import to Shared",
  "title": "Workflows",
  ...
  "retry": "Retry",
  "signIn": "Sign in to your Bitterless account to view shared workflows.",
  "noMembership": "No active institution membership. Ask your administrator to add you.",
  "empty": "Your institution has not shared any workflows yet.",
  "noMatches": "No workflows match your search.",
  "autoSync": "Checks every minute",
  "cloud": "Available to download",
  "synced": "Synced locally",
  "updateAvailable": "Update available",
  "updateFailed": "Update needs retry",
  "sync": "Sync",
  "download": "Download",
  "flow": "Flow",
  "details": "Details",
  "downloading": "Verifying and preparing workflow…",
  "keptPrevious": "Your previous installation is preserved.",
  ...
  "localRevision": "Installed revision",
  "fileName": "Archive",
  "size": "File size",
  "entry": "Entry file",
  "source": "Source",
  ...
  "sourceNotInstalled": "Download this workflow to read its source.",
  "copySource": "Copy source",
  "sourceCopied": "Source copied",
  "copyCommand": "Copy run command",
  "authoredPreview": "This diagram describes the package. Viewing or syncing it does not execute the workflow. Paste the command into chat when you choose to run it.",
  "previewUnavailable": "Preview unavailable. Retry to download and validate this workflow package.",
  "chooseWorkflow": "Explore your institution’s workflows",
  "chooseDescription": "Select a workflow to download its package, inspect the flow and keep your local copy up to date.",

...
| [desktop-mac-dock-icon-size-006](tasks/desktop-mac-dock-icon-size-006.md) | preserve bundle-default macOS Dock icon size while running | in-progress | desktop-mac-dock-icon-004 |

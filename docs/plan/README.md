...
| [translator-thinking-off-008](tasks/translator-thinking-off-008.md) | explicit GPT-5.5 reasoning none with the exact 60-second Translator deadline | in-progress | translator-runtime-diagnostics-007 |

...
| [eyes-on-agents-provider-glyph-refresh-042](tasks/eyes-on-agents-provider-glyph-refresh-042.md) | cleaner Tabler provider marks for Codex and Claude title lines | implemented; owner visual verification pending | eyes-on-agents-claude-setup-recovery-041 |

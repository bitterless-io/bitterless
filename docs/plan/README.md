...
| [eyes-on-agents-stop-reconciliation-025](tasks/eyes-on-agents-stop-reconciliation-025.md) | reconcile stale Hook working from metadata-only latest-turn terminal proof | in-progress | eyes-on-agents-focus-acknowledgement-024, eyes-on-agents-tiered-all-polling-019 |

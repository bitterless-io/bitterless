...
| [translator-inline-retry-003](tasks/translator-inline-retry-003.md) | inline retry action for unchanged-source translation failures | in-progress | translator-language-direction-002 |

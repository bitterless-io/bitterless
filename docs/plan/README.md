...
| [desktop-auto-update-state-replay-008](tasks/desktop-auto-update-state-replay-008.md) | race-safe download-ready replay after renderer rebuild | in-progress | desktop-auto-update-polling-007 |

...
| [model-provider-loopback-diagnostics-011](tasks/model-provider-loopback-diagnostics-011.md) | current-process Codex loopback ownership and sanitized callback evidence | in-progress | model-provider-fresh-login-callback-009, application-diagnostics-010 |

...
| [desktop-helper-process-isolation-001](tasks/desktop-helper-process-isolation-001.md) | Node-only Codex helpers, GUI singleton, and non-blocking Home startup | done | todo-mcp-multi-instance, eyes-on-agents-global-onboarding-008 |

...
| [onlypreview-shell-ux-005](tasks/onlypreview-shell-ux-005.md) | simplify folder-first chrome, locate the previewed file, add native file actions, and anchor Settings to the active window | implemented; independent verification pending | onlypreview-devtools-004 |

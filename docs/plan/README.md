...
| [todo-sqlite-process-ownership-012](tasks/todo-sqlite-process-ownership-012.md) | move synchronized Todo SQLCipher ownership out of Main into Core SQLite preload | in-progress | todoist-sync-desktop-001, todo-renderer-refresh-stability-011 |

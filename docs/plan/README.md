...
| [onlypreview-menubar-003](tasks/onlypreview-menubar-003.md) | align standalone OnlyPreview window chrome with the EyesOnAgents MenuBar pattern | in-progress | onlypreview-standalone-only-002 |

...
| [application-diagnostics-010](tasks/application-diagnostics-010.md) | environment-isolated file logging, sanitized Codex lifecycle evidence, and Settings Log diagnostics | in-progress | model-provider-fresh-login-callback-009 |

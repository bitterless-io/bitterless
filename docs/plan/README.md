...
| [translator-runtime-diagnostics-007](tasks/translator-runtime-diagnostics-007.md) | end-to-end translation deadline, offline model preparation, and dedicated sanitized log | in-progress | translator-fast-mode-006, application-diagnostics-010 |

...
| [release-fast-publish-dependency-sync-003](tasks/release-fast-publish-dependency-sync-003.md) | install frozen-lockfile dependencies before macOS ARM version preparation | in-progress | release-fast-publish-version-code-002 |

...
| [onlypreview-preview-header-merge-018](tasks/onlypreview-preview-header-merge-018.md) | merge the PreviewHeader view into the Preview view and collapse the header-only XPC protocol | implemented; owner E2E verification pending | — |
| [onlypreview-find-in-file-019](tasks/onlypreview-find-in-file-019.md) | `Cmd+F` find bar in the merged Preview header with Monaco/DOM/PDF adapters and Custom Highlight rendering | pending | onlypreview-preview-header-merge-018 |
| [onlypreview-preview-guards-023](tasks/onlypreview-preview-guards-023.md) | extension/content mismatch state, renderer-side pre-engine verification, and PDF byte/page caps with on-demand pages | pending | onlypreview-preview-header-merge-018 |
| [onlypreview-xlsx-grid-020](tasks/onlypreview-xlsx-grid-020.md) | read-only virtualized `.xlsx` grid with sheet tabs, formats, and truthful limits | pending | onlypreview-preview-header-merge-018, onlypreview-preview-guards-023 |
| [onlypreview-docx-render-021](tasks/onlypreview-docx-render-021.md) | paginated `.docx` rendering with sanitized DOM and package-local images | pending | onlypreview-preview-header-merge-018, onlypreview-preview-guards-023 |
| [onlypreview-media-truthful-state-022](tasks/onlypreview-media-truthful-state-022.md) | typed, actionable image/audio/video failure states instead of broken previews | pending | onlypreview-preview-header-merge-018, onlypreview-preview-guards-023 |

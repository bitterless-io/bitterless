...
| [codex-gpt55-retention-008](tasks/codex-gpt55-retention-008.md) | keep GPT-5.5 while adding GPT-5.6 runtime models | ready | model-provider-login-cancel-regression-007 |

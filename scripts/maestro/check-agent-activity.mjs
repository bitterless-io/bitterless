...
assert(maestroWindow.includes("this.broadcastActivity('tool', `call generate_skill"), 'Generate should surface as an internal tool call')
assert(maestroWindow.includes("this.broadcastActivity('tool', `call ingest_recording"), 'Ingest should surface as an internal tool call')
assert(maestroWindow.includes("this.broadcastActivity('tool', `call create_or_update_skill"), 'Trainer skill generation should surface as an internal tool call')
assert(maestroWindow.includes("xpcMain.broadcast('coach/agent-activity'"), 'main should broadcast agent activity to renderer')
assert(maestroWindow.includes("xpcMain.broadcast('coach/agent-thinking'"), 'main should broadcast live thinking state to renderer')

...
const toolsView = readFileSync(join(root, 'renderer/workbench/src/views/WorkbenchToolsView.vue'), 'utf8')
...
assert(coworkWindow.includes('async exportHostApprovalEvents()') && coworkWindow.includes('coach-host-approvals-'), 'main should write host approval export JSON')

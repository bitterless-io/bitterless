...
assert(existsSync(join(root, servicePath)), 'integration target service should exist')
assert(existsSync(join(root, runnerPath)), 'integration runner service should exist')
assert(existsSync(join(root, schedulerPath)), 'integration scheduler service should exist')
assert(existsSync(join(root, mappingPath)), 'integration mapping service should exist')
...
includes('main/windows/coworkWindow.helper.ts', 'listIntegrationTargets()')
includes('main/windows/coworkWindow.helper.ts', 'createIntegrationTargetFromCapture')
includes('main/windows/coworkWindow.helper.ts', 'createAiCrmsMigrationTarget')
includes('main/windows/coworkWindow.helper.ts', 'runIntegrationTargetDryRun')
includes('main/windows/coworkWindow.helper.ts', 'runIntegrationRecordedSiteDryRun')
includes('main/windows/coworkWindow.helper.ts', 'runIntegrationRecordedSitePlan')
includes('main/windows/coworkWindow.helper.ts', 'runIntegrationRecordedSiteApply')
includes('main/windows/coworkWindow.helper.ts', 'buildRecordedSiteApply')
includes('main/windows/coworkWindow.helper.ts', 'buildRecordedSiteDryRun')
includes('main/windows/coworkWindow.helper.ts', 'fetchRecordedSiteRowDetails')
includes('main/windows/coworkWindow.helper.ts', 'recordedSiteRowDetailUrl')
includes('main/windows/coworkWindow.helper.ts', 'mergeRecordedSiteRowDetails')
includes('main/windows/coworkWindow.helper.ts', "'data_mapping', 'mcu_record'")
includes('main/windows/coworkWindow.helper.ts', "['mapping', 'data-map', 'upsert'")
includes('main/windows/coworkWindow.helper.ts', "['mcu', 'record', 'create'")
includes('main/windows/coworkWindow.helper.ts', "['mcu', 'record', 'patient-info', 'update'")
includes('main/windows/coworkWindow.helper.ts', "['mcu', 'record', 'diagnostic-data', 'update'")
includes('main/windows/coworkWindow.helper.ts', "['mcu', 'record', 'conclusion', 'update'")
includes('main/windows/coworkWindow.helper.ts', 'runIntegrationMigration')
includes('main/windows/coworkWindow.helper.ts', 'runIntegrationReportReadiness')
includes('main/windows/coworkWindow.helper.ts', 'setIntegrationTargetSchedule')
includes('main/windows/coworkWindow.helper.ts', 'listIntegrationMappings')
includes('main/windows/coworkWindow.helper.ts', 'upsertIntegrationMapping')
includes('main/windows/coworkWindow.helper.ts', 'deleteIntegrationMapping')
includes('main/windows/coworkWindow.helper.ts', 'integrationScheduler.start')
includes('main/windows/coworkWindow.helper.ts', "name: 'list_integration_targets'")
includes('main/windows/coworkWindow.helper.ts', "name: 'create_integration_target_from_capture'")
includes('main/windows/coworkWindow.helper.ts', "name: 'create_ai_crms_migration_target'")
includes('main/windows/coworkWindow.helper.ts', "name: 'run_integration_dry_run'")
includes('main/windows/coworkWindow.helper.ts', "name: 'run_recorded_site_sync_dry_run'")
includes('main/windows/coworkWindow.helper.ts', "name: 'plan_recorded_site_sync'")
includes('main/windows/coworkWindow.helper.ts', "name: 'apply_recorded_site_sync'")
includes('main/windows/coworkWindow.helper.ts', "name: 'run_integration_migration'")
includes('main/windows/coworkWindow.helper.ts', "name: 'run_integration_report_readiness'")
includes('main/windows/coworkWindow.helper.ts', "name: 'set_integration_schedule'")
includes('main/windows/coworkWindow.helper.ts', "name: 'list_integration_mappings'")
includes('main/windows/coworkWindow.helper.ts', "name: 'upsert_integration_mapping'")
includes('main/windows/coworkWindow.helper.ts', "name: 'delete_integration_mapping'")
...
assert(existsSync(join(root, 'renderer/workbench/src/views/WorkbenchIntegrationsView.vue')), 'Workbench Integrations view should exist')

# Cowork manual verification gates
...
- Download and install a real Bitterless update through the Cowork update affordance.
- Smoke-test signed/native packages on macOS arm64/x64, Windows x64, and Linux x64/arm64.

Do not add real credentials or remote writes to `yarn check:cowork` or the Playwright baseline.
